...
if "%DESTDIR%"=="" (set __prefix=E:\u3d\MongoStandalone\third_party\mongodb) else (set __prefix=!DESTDIR!\u3d\MongoStandalone\third_party\mongodb)

(GOTO) 2>nul & (
  <nul set /p "=Remove file: %__prefix%\bin\msvcp140.dll "
  if EXIST "%__prefix%\bin\msvcp140.dll" (
    del /Q /F "%__prefix%\bin\msvcp140.dll" && echo - ok
  ) ELSE echo - skipped: not present
) && (
  <nul set /p "=Remove file: %__prefix%\bin\msvcp140_1.dll "
  if EXIST "%__prefix%\bin\msvcp140_1.dll" (
    del /Q /F "%__prefix%\bin\msvcp140_1.dll" && echo - ok
  ) ELSE echo - skipped: not present
) && (
  <nul set /p "=Remove file: %__prefix%\bin\msvcp140_2.dll "
  if EXIST "%__prefix%\bin\msvcp140_2.dll" (
    del /Q /F "%__prefix%\bin\msvcp140_2.dll" && echo - ok
  ) ELSE echo - skipped: not present
) && (
  <nul set /p "=Remove file: %__prefix%\bin\msvcp140_atomic_wait.dll "
  if EXIST "%__prefix%\bin\msvcp140_atomic_wait.dll" (
    del /Q /F "%__prefix%\bin\msvcp140_atomic_wait.dll" && echo - ok
  ) ELSE echo - skipped: not present
) && (
  <nul set /p "=Remove file: %__prefix%\bin\msvcp140_codecvt_ids.dll "
  if EXIST "%__prefix%\bin\msvcp140_codecvt_ids.dll" (
    del /Q /F "%__prefix%\bin\msvcp140_codecvt_ids.dll" && echo - ok
  ) ELSE echo - skipped: not present
) && (
  <nul set /p "=Remove file: %__prefix%\bin\vcruntime140_1.dll "
  if EXIST "%__prefix%\bin\vcruntime140_1.dll" (
    del /Q /F "%__prefix%\bin\vcruntime140_1.dll" && echo - ok
  ) ELSE echo - skipped: not present
) && (
  <nul set /p "=Remove file: %__prefix%\bin\vcruntime140.dll "
  if EXIST "%__prefix%\bin\vcruntime140.dll" (
    del /Q /F "%__prefix%\bin\vcruntime140.dll" && echo - ok
  ) ELSE echo - skipped: not present
) && (
  <nul set /p "=Remove file: %__prefix%\bin\concrt140.dll "
  if EXIST "%__prefix%\bin\concrt140.dll" (
    del /Q /F "%__prefix%\bin\concrt140.dll" && echo - ok
  ) ELSE echo - skipped: not present
) && (
  <nul set /p "=Remove file: %__prefix%\bin\msvcp140.dll "
  if EXIST "%__prefix%\bin\msvcp140.dll" (
  ...
  <nul set /p "=Remove file: %__prefix%\lib\bson2.lib "
  if EXIST "%__prefix%\lib\bson2.lib" (
    del /Q /F "%__prefix%\lib\bson2.lib" && echo - ok
  ) ELSE echo - skipped: not present
) && (
  ...
  <nul set /p "=Remove file: %__prefix%\lib\bson2.dll.lib "
  if EXIST "%__prefix%\lib\bson2.dll.lib" (
    del /Q /F "%__prefix%\lib\bson2.dll.lib" && echo - ok
  ) ELSE echo - skipped: not present
) && (
  <nul set /p "=Remove file: %__prefix%\bin\bson2.dll "
  if EXIST "%__prefix%\bin\bson2.dll" (
    del /Q /F "%__prefix%\bin\bson2.dll" && echo - ok
  ) ELSE echo - skipped: not present
) && (
  <nul set /p "=Remove file: %__prefix%\lib\cmake\bson-2.3.3\bson_shared-targets.cmake "
  if EXIST "%__prefix%\lib\cmake\bson-2.3.3\bson_shared-targets.cmake" (
    del /Q /F "%__prefix%\lib\cmake\bson-2.3.3\bson_shared-targets.cmake" && echo - ok
  ) ELSE echo - skipped: not present
) && (
  <nul set /p "=Remove file: %__prefix%\lib\cmake\bson-2.3.3\bson_shared-targets-release.cmake "
  if EXIST "%__prefix%\lib\cmake\bson-2.3.3\bson_shared-targets-release.cmake" (
    del /Q /F "%__prefix%\lib\cmake\bson-2.3.3\bson_shared-targets-release.cmake" && echo - ok
  ) ELSE echo - skipped: not present
) && (
  <nul set /p "=Remove file: %__prefix%\lib\pkgconfig\bson2.pc "
  if EXIST "%__prefix%\lib\pkgconfig\bson2.pc" (
    del /Q /F "%__prefix%\lib\pkgconfig\bson2.pc" && echo - ok
  ) ELSE echo - skipped: not present
) && (
  ...
  <nul set /p "=Remove file: %__prefix%\lib\pkgconfig\mongoc2.pc "
  if EXIST "%__prefix%\lib\pkgconfig\mongoc2.pc" (
    del /Q /F "%__prefix%\lib\pkgconfig\mongoc2.pc" && echo - ok
  ) ELSE echo - skipped: not present
) && (
  ...
  <nul set /p "=Remove file: %__prefix%\lib\mongoc2.lib "
  if EXIST "%__prefix%\lib\mongoc2.lib" (
    del /Q /F "%__prefix%\lib\mongoc2.lib" && echo - ok
  ) ELSE echo - skipped: not present
) && (
  <nul set /p "=Remove file: %__prefix%\lib\mongoc2.dll.lib "
  if EXIST "%__prefix%\lib\mongoc2.dll.lib" (
    del /Q /F "%__prefix%\lib\mongoc2.dll.lib" && echo - ok
  ) ELSE echo - skipped: not present
) && (
  <nul set /p "=Remove file: %__prefix%\bin\mongoc2.dll "
  if EXIST "%__prefix%\bin\mongoc2.dll" (
    del /Q /F "%__prefix%\bin\mongoc2.dll" && echo - ok
  ) ELSE echo - skipped: not present
) && (
