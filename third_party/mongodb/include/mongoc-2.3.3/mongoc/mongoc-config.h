...
#define MONGOC_USER_SET_CFLAGS "/utf-8"

#define MONGOC_USER_SET_LDFLAGS "/machine:x64"

/* MONGOC_CC is used to determine what C compiler was used to compile mongoc */
#define MONGOC_CC "C:/Program Files/Microsoft Visual Studio/18/Insiders/VC/Tools/MSVC/14.51.36231/bin/Hostx64/x64/cl.exe"
